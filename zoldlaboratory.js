...
// look into object storage for your strings

const dialogueObjectsLab = {
    
}

function guessCombination() {
    // take the user input 
    // validate the user input (must be number)
    if (input === "527") {
        return true; 
    } else {
        return "You press the buttons but nothing happens";
    }
    // compare the input to the code 
    // return true or false if its correct
}
